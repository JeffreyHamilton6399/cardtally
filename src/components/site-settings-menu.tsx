...
const GITHUB_URL = "https://github.com/JeffreyHamilton6399/cardtally";

/**
 * Whether the client has hydrated.
 *
 * The theme is only known in the browser, so the first server-rendered paint
 * has to commit to something and would flash if it guessed. This is the
 * useSyncExternalStore form of the usual `mounted` flag: nothing to subscribe
 * to, `false` on the server, `true` once the client takes over.
 */
const neverChanges = () => () => {};
const onClient = () => true;
